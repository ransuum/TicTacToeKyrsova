...
public class MainGameField extends JPanel {
    ...
    void startNewGame() {
        if (count == 5){
            System.out.println("Player1 win Player2 with " + count + " points");
            System.exit(0);
        } else if (count1 == 5) {
            System.out.println("Player2 win Player1 with " + count1 + " points");
            System.exit(0);
        }
        gameOver = false;
        gameOverMessage = "";
    ...
    void twoPlayersMode() {
        ...
        if (player1.win()) {
            count++;
            System.out.println("Player 1 WIN!!!" + " Player1= " + count + " point.");
            gameOver = true;
            gameOverMessage = "Player 1 WIN!!!";
            System.out.println("Кол-во очков у Player1= " + count + " points.");
            System.out.println("Кол-во очков у Player2= " + count1 + " points.");
        }
        repaint();
        ...
        if (player2.win()) {
            count1++;
            System.out.println("Player 2 WIN!!!" + " Player2= " + count1 + " point.");
            gameOver = true;
